'use strict';
((window, document) => {
  const fontsLoadedSubsetClass = 'fonts-loaded-subset';
  ...
  var brandSansRegular = new FontFaceObserver('Brand Sans', {
    weight: 400
  });

  Promise.all([brandSansRegular.load(null, 10000)]).then(function () {
