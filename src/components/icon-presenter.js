...
import * as styles from './icon-presenter.styles';
...
const IconPresenter = ({ svgSprite }) => {
  ...
  return (
    <section className="icons-standard" css={styles.iconsStandardCss}>
      <span className="icons-descriptor" css={styles.iconsDescriptorCss}>
