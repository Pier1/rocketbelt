...
```html
<nav class="progress-stepped" aria-label="Add a description appropriate to your context!">
...
manipulation is currently left up to the consuming app.* The function that
controls the example above is:
