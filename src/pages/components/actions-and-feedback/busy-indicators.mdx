...
```html
<button class="button is-busyable is-busy is-busy-spinner is-busy-opaque">Trigger Busy</button>
<button class="button is-busyable is-busy">Trigger Busy</button>
<button class="button button-primary is-busyable is-busy is-busy-inverted">Trigger Busy</button>
```
